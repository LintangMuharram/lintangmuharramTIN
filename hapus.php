...
// Jika buku sedang dipinjam, tampilkan pesan dan redirect ke
halaman index.php
echo "Buku sedang dalam peminjaman. Tidak dapat dihapus.";
header("refresh:3;url=index.php"); // Redirect ke halaman
index.php setelah 3 detik
exit();
} else {
// Jika buku tidak sedang dipinjam, lanjutkan proses
penghapusan
